...
# Cache root: $DH_CACHE_DIR/<CACHE_VERSION>/ (default /data/cache/v17/ in
# Docker via Dockerfile ENV; ./data/cache/v17/ in bare-Python local dev).
...
def health():
    ...
    - cache_version : engine.CACHE_VERSION, e.g. "v17".
